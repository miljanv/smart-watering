                        ...
                        <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                            <form class="register-form py-5 w-100" method="post" action="">
                                <div class="input-material-group mb-3">
                                    <input class="input-material" type="text" name="username" required>
                                ...
                                ?>
                                <button class="btn btn-primary mb-3 mt-2" id="login" type="submit">Register</button>
                                <br><small class="text-gray-500">Already have an account? </small><a
                                        class="text-sm text-paleBlue" href="login.php">Login</a>
                            </form>
                        </div>
                    </div>
                </div>
